...
docker run --privileged --rm --network host -e NODE_ID="$NODE_ID" -e BROKER_HOST=gateway --add-host=gateway:192.168.0.1 --cap-add SYS_TIME --volume /dev:/dev --entrypoint "/sensor_node_bringup_bat.bash" timebay:sensor
